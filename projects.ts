export const projects = [
  {
    name: "LookForward",
    description:
      "App developed with React Native, Firebase, The Movie Database (TMDB) API, and Twitch's IGDB API. Keep track of upcoming movie and game releases.",
    img: "/lookforward.png",
    tags: [
      "react native",
      "firebase",
    ...
    link: "https://getlookforward.app",
  },
  {
    name: "Marvel Ratings Web App",
    description:
