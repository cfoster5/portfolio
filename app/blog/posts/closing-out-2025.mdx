...
[LookForward](https://www.getlookforward.app) is an iOS app I built almost 6 years ago to help people discover and track release dates for movies and video games. I came up with the name when I was driving to my grandparents and said to myself "I need something to look forward to" while I was struggling through a breakup. It's deeply personal to me, which is why I pour myself into it.
...
[Simply Water](https://coreyfoster.dev/simply-water) is an iOS app that let's you track how much water you've had throughout the day. I built it at the beginning of the year after passing out from being dehydrated. It's incredibly minimal compared to other hydration tracking apps. I vibe coded it over a weekend, using it as my first testbed for AI assisted development with GitHub Copilot.
